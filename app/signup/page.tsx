  ...
  return (
    <div className="auth-root">
      ...
      <div className="auth-right">
        <div className="auth-card">
          ...
          <div className="auth-heading">
            ...
            <p>Start tracking events across Nigeria</p>
          </div>
      ...
      <style>{`
        ...
        .auth-left { display: none; position: relative; flex-direction: column; justify-content: space-between; padding: 3rem; background: var(--bg); overflow: hidden; }
        ...
        .auth-headline { font-size: clamp(2rem,3vw,2.75rem); font-weight: 900; color: var(--text); line-height: 1.15; letter-spacing: -0.03em; margin: 0 0 1.25rem; }
        .auth-typewriter { font-size: clamp(1.125rem,1.8vw,1.375rem); font-weight: 600; color: #4f8ef7; line-height: 1.5; margin: 0 0 2rem; min-height: 2em; }
        .auth-cursor { display: inline-block; width: 2.5px; height: 1em; background: #4f8ef7; margin-left: 3px; vertical-align: middle; border-radius: 2px; animation: blink 1s step-end infinite; }
        ...
        .auth-right { width: 100%; display: flex; align-items: center; justify-content: center; padding: 2.5rem 2rem; background: var(--surface); min-height: 100vh; }
        @media (min-width: 1024px) { .auth-right { width: 50%; min-height: auto; border-left: 1px solid var(--border); } }
